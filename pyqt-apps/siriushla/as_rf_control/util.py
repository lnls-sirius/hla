    ...
    'BO': {
        ...
        'TunDtls': {
            ...
            'Manual': {
                ...
                '306': ['Plunger 1 Move Dir', 'RA-RaBO01:RF-LLRF:TunnerDir'],
                '305': ['Plunger 1 Move', 'RA-RaBO01:RF-LLRF:TunnerMove'],
                '315': ['Plunger 2 Move Dir', 'RA-RaBO01:RF-LLRF:PLG2Dir'],
                '314': ['Plunger 2 Move', 'RA-RaBO01:RF-LLRF:PLG2Move'],
                '307': ['Tuning Reset', 'RA-RaBO01:RF-LLRF:TunnerMove-Cmd'],
                '302 Man': ['Plunger 1 Manual Dn', 'BO-05D:RF-P5Cav:TunnerManDown-Mon'],
                '303 Man': ['Plunger 1 Manual Up', 'BO-05D:RF-P5Cav:TunnerManUp-Mon'],
