...
SEC_2_CHANNELS = {
    'BO': {
        ...
        'ADCs and DACs': {
            'Input': {
                '0': ['Cavity Voltage (RFin1)', '$(cav):PwrCell3'],
                '2': ['Forward Power (RFin2)', '$(cav):PwrFwd'],
                '24': ['Rev Pwr Cavity (RFin3)', '$(cav):PwrRevI-Mon'],
                '35': ['Master Osc (RFin4)', 'RA-RaMO:RF-Gen:PwrBOLLRF'],
                '20': ['Fwd Pwr SSA 1 (RFin5)', 'RA-To$(sys)$(sidx)01:RF-SSAmpTower:PwrFwdOut'],
                '22': ['Rev Pwr SSA 1 (RFin6)', 'RA-To$(sys)$(sidx)01:RF-SSAmpTower:PwrRevOut'],
                '37': ['Cell 2 Voltage (RFin7)', '$(cav):Cell2Pwr'],
                '39': ['Cell 4 Voltage (RFin8)', '$(cav):Cell4Pwr'],
                '41': ['Cell 1 Voltage (RFin9)', '$(cav):Cell1Pwr'],
                '43': ['Cell 5 Voltage (RFin10)', '$(cav):Cell5Pwr'],
                '45': ['Pre-Drive Input (RFin11)', 'RA-Ra$(sys)$(sidx)01:RF-LLRFPreAmp:PwrFwdIn1'],
                '47': ['Pre-Drive Output Fwd (RFin12)', 'RA-Ra$(sys)$(sidx)01:RF-LLRFPreAmp:PwrFwdOut1'],
                '49': ['Pre-Drive Output Rev (RFin13)', 'RA-Ra$(sys)$(sidx)01:RF-LLRFPreAmp:PwrRevOut1'],
                '51': ['Circulator Out Fwd (RFin14)', 'RA-TL:RF-Circulator-$(sys)$(sidx):PwrFwdOut'],
                '53': ['Circulator Out Rev (RFin15)', 'RA-TL:RF-Circulator-$(sys)$(sidx):PwrRevOut'],
                '91': ['Mux DACsIF (RFin16)', 'RA-Ra$(sys)$(sidx)01:$(llrf):DACIF'],
            },
            'Control': {
        ...
        'AdvIntlk': {
            'A': {
                ...
                'Bypass': {
                    ...
                    '816 1': ['End Switch Up 1', 'RA-RaSIA01:RF-LLRF-A:FIMPLG1Up'],
                    '817 1': ['End Switch Down 1', 'RA-RaSIA01:RF-LLRF-A:FIMPLG1Down'],
            ...
            'B': {
                ...
                'Bypass': {
                    ...
                    '816 1': ['End Switch Up 1', 'RA-RaSIB01:RF-LLRF-B:FIMPLG1Up'],
                    '817 1': ['End Switch Down 1', 'RA-RaSIB01:RF-LLRF-B:FIMPLG1Down'],
