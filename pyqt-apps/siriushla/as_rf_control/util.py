...
SEC_2_CHANNELS = {
    'BO': {
        ...
        'AdvIntlk': {
            ...
            'Bypass': {
                '806': ['Rev SSA 1', 'RA-Ra$(sys)$(sidx)01:$(llrf):FIMRevSSA1'],
                '807': ['Rev SSA 2', 'RA-Ra$(sys)$(sidx)01:$(llrf):FIMRevSSA2'],
                '808': ['Rev SSA 3', 'RA-Ra$(sys)$(sidx)01:$(llrf):FIMRevSSA3'],
                '809': ['Rev SSA 4', 'RA-Ra$(sys)$(sidx)01:$(llrf):FIMRevSSA4'],
                '810': ['Rev Cavity', 'RA-Ra$(sys)$(sidx)01:$(llrf):FIMRevCav'],
                '811': ['Manual Interlock', 'RA-Ra$(sys)$(sidx)01:$(llrf):FIMManual'],
                '812': ['PLC', 'RA-Ra$(sys)$(sidx)01:$(llrf):FIMPLC'],
                '813': ['Ext LLRF 1', 'RA-Ra$(sys)$(sidx)01:$(llrf):FIMLLRF1'],
                '814': ['Ext LLRF 2', 'RA-Ra$(sys)$(sidx)01:$(llrf):FIMLLRF2'],
                '815': ['Ext LLRF 3', 'RA-Ra$(sys)$(sidx)01:$(llrf):FIMLLRF3'],
                '816 1': ['End Switch Up 1', 'RA-Ra$(sys)$(sidx)01:$(llrf):FIMPLG1Up'],
                '817 1': ['End Switch Down 1', 'RA-Ra$(sys)$(sidx)01:$(llrf):FIMPLG1Down'],
                '816 2': ['End Switch Up 2', 'RA-Ra$(sys)$(sidx)01:$(llrf):FIMPLG2Up'],
                '817 2': ['End Switch Down 2', 'RA-Ra$(sys)$(sidx)01:$(llrf):FIMPLG2Down'],
                '835': ['ILK VCav', 'RA-Ra$(sys)$(sidx)01:$(llrf):FIMCav'],
                '836': ['ILK Fwd Cav', 'RA-Ra$(sys)$(sidx)01:$(llrf):FIMFwdCav'],
                '837': ['ILK Fw SSA 1', 'RA-Ra$(sys)$(sidx)01:$(llrf):FIMFwdSSA1'],
                '838': ['ILK RF In 7', 'RA-Ra$(sys)$(sidx)01:$(llrf):FIMRFIn7'],
                '839': ['ILK RF In 8', 'RA-Ra$(sys)$(sidx)01:$(llrf):FIMRFIn8'],
                '840': ['ILK RF In 9', 'RA-Ra$(sys)$(sidx)01:$(llrf):FIMRFIn9'],
                '841': ['ILK RF In 10', 'RA-Ra$(sys)$(sidx)01:$(llrf):FIMRFIn10'],
                '842': ['ILK RF In 11', 'RA-Ra$(sys)$(sidx)01:$(llrf):FIMRFIn11'],
                '843': ['ILK RF In 12', 'RA-Ra$(sys)$(sidx)01:$(llrf):FIMRFIn12'],
                '844': ['ILK RF In 13', 'RA-Ra$(sys)$(sidx)01:$(llrf):FIMRFIn13'],
                '845': ['ILK RF In 14', 'RA-Ra$(sys)$(sidx)01:$(llrf):FIMRFIn14'],
                '846': ['ILK RF In 15', 'RA-Ra$(sys)$(sidx)01:$(llrf):FIMRFIn15'],
                '847': ['ILK LLRF Beam Trip', 'RA-Ra$(sys)$(sidx)01:$(llrf):FIMOrbitIntlk']
            }
        }
    },
    'SI': {
