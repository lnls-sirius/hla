...
class LIInterlockWindow(SiriusMainWindow):
    ...
    def _setup_ui(self):
        ...
        lay.addLayout(self.grid_warn, 3, 0, Qt.AlignmentFlag.AlignTop)
        lay.addWidget(self.label_digin, 2, 1)
        lay.addWidget(QLabel('Mask', self, alignment=Qt.AlignmentFlag.AlignRight), 2, 2)
        lay.addLayout(self.grid_digin, 3, 1, 1, 2, Qt.AlignmentFlag.AlignTop)
        lay.addWidget(self.label_digout, 2, 3)
        lay.addWidget(QLabel('Mask', self, alignment=Qt.AlignmentFlag.AlignRight), 2, 4)
        lay.addLayout(self.grid_digout, 3, 3, 1, 2, Qt.AlignmentFlag.AlignTop)
