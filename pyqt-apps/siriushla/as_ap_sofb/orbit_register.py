...
class OrbitRegister(QWidget):
    ...
    def _edit_orbit(self):
        ...
        multx.setText('1.0')
        # multx.setAlignment(Qt.AlignmentFlag.AlignVCenter | Qt.AlignmentFlag.AlignRight)
        multx.setAlignment(Qt.AlignmentFlag.AlignCenter)
        ...
        addx.setText('0.0')
        addx.setAlignment(Qt.AlignmentFlag.AlignCenter)
        ...
        multy.setText('1.0')
        # multy.setAlignment(Qt.AlignmentFlag.AlignVCenter | Qt.AlignmentFlag.AlignRight)
        multy.setAlignment(Qt.AlignmentFlag.AlignCenter)
        ...
        addy.setText('0.0')
        addy.setAlignment(Qt.AlignmentFlag.AlignCenter)
    ...
    def _create_bump(self):
        ...
        angx.setText('0.0')
        angx.setAlignment(Qt.AlignmentFlag.AlignCenter)
        ...
        posx.setText('0.0')
        posx.setAlignment(Qt.AlignmentFlag.AlignCenter)
        ...
        angy.setText('0.0')
        angy.setAlignment(Qt.AlignmentFlag.AlignCenter)
        ...
        posy.setText('0.0')
        posy.setAlignment(Qt.AlignmentFlag.AlignCenter)
