...
from .controls import SITuneMonitor, TuneControls
...
class Tune(SiriusMainWindow):
    ...
    def __init__(self, parent=None, prefix=VACA_PREFIX, section=''):
        ...
        self.setWindowIcon(
            qta.icon(
                'mdi.pulse', color=util.get_appropriate_color(self.section)
            )
        )
        self._setupUi()
