...
class IDFFWindow(SiriusMainWindow):
    ...
    def _basicSettingsWidget(self):
        ...
        lay.addWidget(self.le_configname, 0, 1, 1, 3)
        lay.addWidget(self.lb_configname, 1, 1, 1, 3)
        lay.addItem(QSpacerItem(0, 15, QSzPlcy.Ignored, QSzPlcy.Fixed), 2, 0)
        lay.addWidget(ld_loopstate, 3, 0)
        lay.addWidget(self.sb_loopstate, 3, 1)
        lay.addWidget(self.lb_loopstate, 3, 2)
        lay.addWidget(ld_loopfreq, 4, 0)
        lay.addWidget(self.sb_loopfreq, 4, 1)
        lay.addWidget(self.lb_loopfreq, 4, 2, 1, 2)
